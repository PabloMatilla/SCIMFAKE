...
def preprocessing(image_path, image_size = (384, 256)):
    # Cargar la imagen
...
def CNN():
    ...
    model.add(Input(shape=(384, 256, 3)))

    # Cinco capas convolucionales con normalización por lotes y agrupamiento máximo
    model.add(Conv2D(16, (3, 3), activation='relu', input_shape=(384, 256, 3), kernel_regularizer=l2(0.01)))
...
model.save("imageforgerymodel.keras")

laodedmodel = load_model("imageforgerymodel.keras")
laodedmodel.summary()